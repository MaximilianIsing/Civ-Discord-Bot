...
class Wonder:
    def __init__(self, name, cost, civ, unlock, effect, condition):
        self.name = name
        self.cost = cost
        self.civ = civ
        self.unlock = unlock
...
antiquityWonders = [
    Wonder("Angkor Wat", 450, "Khmer", "Civic: Philosophy", "+3 Happiness. +1 Specialist limit in this Settlement.", "Adjacent to a River tile."),
    Wonder("Byrsa", 375, "Carthage", "Tech: Sailing", "+2 Gold. Trade Routes from this Settlement cannot be plundered. All tiles in this City adjacent to Coast receive a Wall if eligible for it.", "Adjacent to Coast."),
    Wonder("Colosseum", 450, "Rome", "Civic: Entertainment", "+3 Culture. +2 Happiness on Quarters in this Settlement.", "Adjacent to a District."),
    Wonder("Colossus", 450, "None", "Civic: Skilled Trades", "+3 Gold. +3 Resource Capacity in this Settlement. +1 Economic Attribute point.", "On Coast adjacent to land."),
    Wonder("Dur_Sharrukin", 275, "None", "Civic: Discipline", "Acts like a Fortified District. +3 Combat Strength to all Fortified Districts in all Settlements.", "On a Flat tile."),
    Wonder("Emile Bell", 275, "None", "Civic: Code of Laws Mastery", "Gain a unique Endeavor, Ginseng Agreement, which grants Food in both Leaders' Capital. +1 Diplomatic Attribute point.", "On a Rough tile."),
    Wonder("Gate of All Nations", 275, "Persia", "Civic: Discipline Mastery", "+2 Support on all Wars.", "Adjacent to a District."),
    Wonder("Great Stele", 275, "Aksum", "Tech: Writing", "+200 Gold every time a Wonder is completed in this Settlement, including the Great Stele.", "On a Flat tile."),
    Wonder("Haamonga a Maui", 375, "None", "Tech: Navigation", "+2 Culture. +1 Culture and +1 Food on Fishing Boats in this Settlement. +1 Cultural Attribute point.", "On a Grassland or Tropical tile adjacent to Coast."),
    Wonder("Hanging Gardens", 275, "None", "Tech: Irrigation", "+1 Food on Farms in this Settlement. +10% growth rate in all cities. +1 Expansionist Attribute point.", "Adjacent to a River."),
    Wonder("Mausoleum of Theodoric", 450, "None", "Civic: Organized Military", "+3 Production. +100% yields and HP from pillaging. +1 Militaristic Attribute point.", "Adjacent to Coast."),
    Wonder("Monks Mound", 450, "Mississippian", "Civic: Commerce", "+4 Food. +4 Resource Capacity in this Settlement.", "Adjacent to a River."),
    Wonder("Mundo Perdido", 275, "Maya", "Civic: Mysticism Mastery", "+1 Happiness and +1 Science on Tropical tiles in this Settlement.", "On a Tropical tile."),
    Wonder("Nalanda", 450, "None", "Civic: Literacy", "+3 Science. +1 Codex. Has 2 Codex slots. +1 Scientific Attribute point.", "On a Plains tile."),
    Wonder("Oracle", 375, "Greece", "Civic: Public Life", "+2 Culture. When gaining rewards from a Narrative Event, gain additional +10 Culture per Age.", "On a Rough tile."),
    Wonder("Petra", 375, "None", "Civic: Code of Laws", "+2 Gold. +1 Gold and +1 Production for every Desert tile in this Settlement.", "On a Desert tile."),
    Wonder("Pyramid Of The Sun", 450, "None", "Tech: Mathematics", "+3 Culture. +3 Culture on each Quarter in this Settlement.", "On a Flat tile adjacent to a District."),
    Wonder("Pyramids", 275, "Egypt", "Tech: Masonry", "+1 Gold and +1 Production on minor and Navigable River tiles in this Settlement.", "On a Desert adjacent to a Navigable River tile."),
    Wonder("Sanchi Stupa", 375, "Maurya", "Civic: Citizenship Mastery", "+2 Happiness. +1 Culture for excess Happiness in this Settlement.", "On a Plains tile."),
    Wonder("Terracotta Army", 375, "None", "Civic: Tactics", "+2 Production. Grants a free Army Commander when built. +25% Army experience.", "On a Grassland tile."),
    Wonder("Weiyang Palace", 375, "Han", "Civic: Citizenship", "+6 Influence.", "On a Grassland tile."),
]
explorationWonders = [
    Wonder("Borobudur", 475, "Majapahit", "Civic: Bureaucracy", "+3 Happiness. +2 Food and +2 Happiness on Quarters.", "Adjacent to a Coast tile."),
    Wonder("Brihadeeswarar Temple", 475, "Chola", "Civic: Diplomatic Service", "+3 Influence. All Buildings with an active adjacency receive +1 Happiness adjacency with Navigable Rivers.", "On a Minor River or adjacent to a Navigable River."),
    Wonder("El Escorial", 475, "Spain", "Civic: Colonialism Mastery", "+3 Happiness. Has 3 Relic slots. +1 Settlement Limit. +4 Happiness on cities within 7 tiles of this Wonder.", "On a Rough tile."),
    Wonder("Erdene Zuu", 550, "Mongolia", "Civic: Imperialism Mastery", "+4 Culture. Creating a Cavalry Unit grants Culture equal to 25% of its cost.", "On Flat Plains, Flat Tundra, or Flat Desert tile."),
    Wonder("Forbidden City", 400, "Ming", "Civic: Authority Mastery", "+2 Culture. +2 Culture and +2 Gold on all Fortification buildings in this Settlement.", "Adjacent to a District."),
    Wonder("Hale o Keawe", 400, "Hawaiia", "Civic: Inspiration", "+2 Culture. Constructing a building on Coast grants Culture equal to 50% of its cost. Has 3 Relic slots.", "Adjacent to Coast, but not adjacent to Tundra."),
    Wonder("House of Wisdom", 475, "Abbasid", "Civic: Society Mastery", "+3 Science. Gains 3 Relics. +2 Science on Great Works. Has 3 Relic slots.", "Adjacent to an Urban district."),
    Wonder("Machu Pikchu", 550, "Inca", "Tech: Urban Planning", "+4 Gold. Increased Resource Capacity in this Settlement. +4 Culture and +4 Gold on all tiles adjacent to this Wonder.", "On a Tropical Mountain tile."),
    Wonder("Notre Dame", 550, "None", "Civic: Social Class Mastery", "+4 Happiness. All Specialists provide +3 Culture during celebrations. Start a celebration immediately upon completion.", "Adjacent to a River and a District."),
    Wonder("Rila Monastery", 550, "Bulgaria", "Tech: Heraldry", "+4 Culture. Has 3 Relic Slots. Receive a Relic every time you build a Wonder, including this one.", "Not adjacent to a District."),
    Wonder("Serpent Mound", 550, "Shawnee", "Tech: Astronomy", "+4 Influence. +3 Science and +2 Production to all unique improvements in this Settlement.", "On a Grassland tile."),
    Wonder("Shwedagon Zedi Daw", 550, "None", "Tech: Education", "+4 Science. +2 Science on all Rural tiles in this Settlement that have at least 1 Happiness. +1 Wildcard Attribute Point.", "Adjacent to a Lake."),
    Wonder("Tomb of Askia", 400, "Songhai", "Civic: Mercantilism", "+2 Gold. +2 Resource Capacity in this Settlement. +2 Gold and +2 Production in this Settlement for every Resource assigned to it.", "On a Desert tile."),
    Wonder("White Tower", 400, "Norman", "Civic: Sovereignty Mastery", "+4 Happiness. +4 Happiness in this Settlement for every Tradition slotted in your Government.", "Adjacent to a City Hall."),
]
modernWonders = [
    Wonder("Battersea Power Station", 1000, "Great Britain", "Tech: Electricity Mastery", "+4 Production. When training a Naval Unit, receive an additional Naval Unit of the same type.", "Adjacent to water."),
    Wonder("Boudhanath", 1000, "Nepal", "Civic: Nationalism", "+4 Influence. Increase your Relationship with all other leaders by 20.", "On a Tropical tile and adjacent to a Mountain."),
    Wonder("Brandenburg Gate", 1400, "Prussia", "Civic: Militarism Mastery", "+6 Production. No Happiness penalty from War Weariness. +5 Happiness in conquered Settlements.", "Adjacent to a District."),
    Wonder("Chengde Mountain Resort", 1400, "Qing", "Civic: Hegemony Mastery", "+6 Gold. +5% Culture for each civilization you have a Trade Route with.", "Adjacent to a Mountain."),
    Wonder("Dogo Onsen", 1000, "Meiji Japan", "Civic: Social Question", "+4 Happiness. This Settlement gains 1 Population upon entering a celebration.", "Adjacent to a Coast tile."),
    Wonder("Doi Suthep", 1000, "Siam", "Civic: Political Theory", "+4 Influence. +5 Culture and +5 Gold for each City-State you are Suzerain of.", "On a Rough tile."),
    Wonder("Eiffel Tower", 1200, "French Empire", "Tech: Radio", "+5 Culture. +2 Culture and +2 Happiness on Quarters in this Settlement.", "Adjacent to a District."),
    Wonder("Hermitage", 1000, "Russia", "Civic: Modernization", "+4 Culture. +10% Culture in cities with a Great Work. Has 3 Great Work slots.", "On a Tundra tile."),
    Wonder("Manhattan Project", 1200, "None", "Ideology (Military Legacy Path)", "Grants a Nuclear Weapon and unlocks Operation Ivy project.", "No placement requirement."),
    Wonder("Muzibu Azaala Mpanga", 1000, "Buganda", "Civic: Natural History", "+4 Food. +2 Food on all Lake tiles. +2 Culture and +2 Happiness on all Lake tiles in this Settlement.", "Adjacent to a Lake."),
    Wonder("Oxford University", 1000, "None", "Civic: Academics", "+4 Science. Grants 2 free technologies. +1 Wildcard Attribute point.", "Adjacent to a District."),
    Wonder("Palacio de Bellas Artes", 1200, "Mexico", "Civic: Globalism Mastery", "+5 Culture. +2 Happiness on Great Works. +10% Happiness in this Settlement. Has 3 Artifact Slots.", "Adjacent to an Urban District."),
    Wonder("Red Fort", 1000, "Mughal", "Tech: Military Science", "+4 Gold. Acts as a Fortified District. +50 HP to this tile and all City Centers.", "Adjacent to a District."),
    Wonder("Statue of Liberty", 1400, "America", "Civic: Capitalism Mastery", "+6 Happiness. Spawns 4 Migrants.", "On a Coast tile adjacent to land."),
    Wonder("Taj Mahal", 1200, "None", "Civic: Nationalism Mastery", "+5 Gold. +50% Celebration duration. +1 Wildcard Attribute point.", "No placement requirement."),
]
