...
explorationWonders = [
    ...
    Wonder("Exploration","Hale o Keawe", 400, "Hawaiia", "Civic: Inspiration", "+2 Culture. Constructing a building on Coast grants Culture equal to 50% of its cost. Has 3 Relic slots.", "Adjacent to Coast, but not adjacent to Tundra."),
